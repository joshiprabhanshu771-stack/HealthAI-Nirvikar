...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function init() {
    // If tips are embedded in window.INITIAL_TIPS, use them; otherwise fetch from REST API
    if (window.INITIAL_TIPS && Array.isArray(window.INITIAL_TIPS) && window.INITIAL_TIPS.length > 0) {
      allTips = window.INITIAL_TIPS;
    } else {
