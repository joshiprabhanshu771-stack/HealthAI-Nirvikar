-- ==========================================================
-- HealthAI — Health & Wellness Module Database Schema
-- Database: MySQL
-- ==========================================================
...
CREATE TABLE IF NOT EXISTS health_tips (
    ...
    icon VARCHAR(100) DEFAULT 'fa-heart-pulse',
    ...
    FULLTEXT INDEX idx_search (title, category, short_description, keywords)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ==========================================================
-- 2. Initial Evidence-Informed Health Tips (21 Verified Records)
-- Sources: WHO, CDC, NHS, Harvard Health, AHA, Sleep Foundation, ACSM
-- ==========================================================

INSERT INTO health_tips (
    title, category, icon, short_description, description, why_it_matters,
    actionable_tip, important_considerations, visual_type, visual_data,
    keywords, source_name, source_url
) VALUES
-- 1. HYDRATION: Fluid Requirements & Age Guide
(
...
-- 9. EXERCISE: Gradual Progression
(
...
-- 15. MENTAL WELLNESS: Box Breathing
(
...
-- 16. MENTAL WELLNESS: Social Connection
(
...
-- 19. HEART HEALTH: Cardiovascular Lifestyle
(
...
-- 20. HEART HEALTH: Blood Pressure Scale
(
