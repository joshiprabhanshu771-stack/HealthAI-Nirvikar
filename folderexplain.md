...
- `backend/src/main/resources/db/migration/` - Versioned Flyway migrations:
  ...
  - `V101__seed_pregnancy_care.sql` - Pregnancy care trimesters, nutrition, and warning sign seed data.
...
- `service/impl/PregnancyCareServiceImpl.java` - Pregnancy Care calculations (Naegele's rule, gestational age, trimester triage) and data retrieval.
...
- `frontend/src/pages/pregnancy_care.html` - Dedicated Pregnancy Care module with due date calculator, trimester tabs, prenatal diet guide, and hospital bag checklist.
...
- `frontend/src/assets/js/pregnancy_care.js` - Due date calculator, trimester tabs, food filter, and persistent hospital bag checklist.
- `frontend/src/services/api.js` - Shared frontend API client for health-tip and pregnancy-care requests.
