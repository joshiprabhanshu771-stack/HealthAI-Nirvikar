...
/**
 * Entity representing a health tip stored in the health_tips table.
 */
public class HealthTip {
    ...
    public String getActionableTip() { return actionableTip; }
    public void setActionableTip(String actionableTip) { this.actionableTip = actionableTip; }

    public String getImportantConsiderations() { return importantConsiderations; }
    public void setImportantConsiderations(String importantConsiderations) { this.importantConsiderations = importantConsiderations; }
